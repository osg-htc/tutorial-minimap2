...
mkdir -p /ospool/guest-ap/data/jovyan/tutorial-minimap2/software
mkdir -p /ospool/guest-ap/data/jovyan/tutorial-minimap2/inputs
mkdir -p ~/tutorial-minimap2/inputs
mkdir -p ~/tutorial-minimap2/outputs

echo "Created necessary directory structure ✅"
...
echo "⏳ Starting data download from OSG Public OSDF Directory...⏳ ⬇️"
...
osdf object get /ospool/uc-shared/public/osg-training/tutorial-minimap2/inputs/humpback_whale_ref_genome.fasta.mmi /ospool/guest-ap/data/jovyan/tutorial-minimap2/inputs/ > /dev/null
